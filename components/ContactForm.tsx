  ...
  return (
    <form class={tw`w-full max-w-lg mx-auto`} id='contact'>
        <div class={tw`flex flex-wrap -mx-3 mb-6`}>
            ...
            <input class={tw`appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white`} id="grid-first-name" type="text" placeholder="Jane" /> 
            <p class={tw`text-red-500 text-xs italic`}>Please fill out this field.</p>
            </div>
        ...
        <div class={tw`flex flex-wrap -mx-3 mb-6`}>
         ...
         <div class={tw`flex flex-wrap -mx-3 mb-6`}>
             ...
             <p class={tw`text-gray-600 text-xs italic`}>Re-size can be disabled by set by resize-none / resize-y / resize-x / resize</p>
             </div>
         </div>
         <div class={tw`md:flex md:items-center`}>
             <div class={tw`md:w-1/3`}>
             <button class={tw`shadow bg-teal-400 hover:bg-teal-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded`} type="button">
                 Send
             </button>
             </div>
             <div class={tw`md:w-2/3`}></div>
         </div>
    </form>
  );
}
